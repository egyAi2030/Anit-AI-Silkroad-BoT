...
namespace SilkroadAIBot.Core.Networking
{
    public class LoginManager
    {
        ...
        public LoginManager(WorldState worldState, SilkroadAIBot.Core.Data.DataManager dataManager)
        {
        ...
        private void HandleAgentPacket(Packet packet, uint sessionID)
        {
             ...
             switch (packet.Opcode)
             {
                ...
                case Opcode.SERVER_CHARACTER_SELECTION_ACTION_RESPONSE: // 0xB007 (Char List)
                    LogService.Info("[Agent] Character Selection Data received. Selecting 'EgyBot'...");
                    SelectCharacter("EgyBot");
                    break;
