...
namespace SilkroadAIBot.Bot
{
    public class BotController
    {
        ...
        private SilkroadAIBot.Core.Data.DatabaseManager _db;
        private List<IBundle> _bundles;
        private bool _isRunning;
        private DateTime _lastSaveTime;

        public BotController(WorldState worldState, ClientlessConnection connection, SilkroadAIBot.Core.Data.DatabaseManager db)
        {
